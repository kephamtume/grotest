      ...
      <form action="" method="POST">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               ...
               <input type="text" name="street" placeholder="e.g. Shaabab" class="box" required>
            </div>
            <div class="inputBox">
               <span>city :</span>
               <input type="text" name="city" placeholder="e.g. Nakuru" class="box" required>
            </div>
            <div class="inputBox">
               <span>state :</span>
               <input type="text" name="state" placeholder="e.g. Nakuru County" class="box" required>
            </div>
            <div class="inputBox">
               <span>country :</span>
